...
#region  Private variables
		/// <summary> The number of items in the vector.  </summary>
		const int SIZE = 6;

		/// <summary> Shearing of the <c>Y</c> axis in <c>Z</c> direction. </summary>
		[SerializeField] private float _yz;

		/// <summary> Shearing of the <c>Z</c> axis in <c>X</c> direction. </summary>
		[SerializeField] private float _zx;

		/// <summary> Shearing of the <c>X</c> axis in <c>Y</c> direction. </summary>
		[SerializeField] private float _xy;

		/// <summary> Shearing of the <c>Z</c> axis in <c>Y</c> direction. </summary>
		[SerializeField] private float _zy;

		/// <summary> Shearing of the <c>X</c> axis in <c>Z</c> direction. </summary>
		[SerializeField] private float _xz;

		/// <summary> Shearing of the <c>Y</c> axis in <c>X</c> direction. </summary>
...
#region  Constructors
		...
		public static Vector6 Zero {
			get => new Vector6(0f, 0f, 0f, 0f, 0f, 0f);
		}
...
#region  ShearMatrix
		...
		public static Matrix4x4 ShearMatrix(Vector6 v) {
			...
			result[0, 1] = v.YX; result[0, 2] = v.ZX;
			result[1, 0] = v.XY; result[1, 2] = v.ZY;
			result[2, 0] = v.XZ; result[2, 1] = v.YZ;
...
#region  Math
		...
		public static Vector6 Subtract(Vector6 minuend, Vector6 subtrahend) {
			var result = new Vector6(minuend);
		...
		public static Vector6 Scale(Vector6 multiplier, Vector6 multiplicand) {
			var result = new Vector6(multiplier);
			result.Scale(multiplicand);
			return result;
		}
