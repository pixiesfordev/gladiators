...
#region  Constants
		/// <summary> Height of the matrix type. </summary>
		public const int Height = 3;

		/// <summary> Width of the matrix type. </summary>
		public const int Width  = 3;
#endregion  // Constants

#region  Properties
		/// <summary> The first row and first column value. </summary>
		public float M11 {get; set;}

		/// <summary> The first row and second column value. </summary>
		public float M12 {get; set;}

		/// <summary> The first row and third column value. </summary>
		public float M13 {get; set;}

		/// <summary> The second row and first column value. </summary>
		public float M21 {get; set;}

		/// <summary> The second row and second column value. </summary>
		public float M22 {get; set;}

		/// <summary> The second row and third column value. </summary>
		public float M23 {get; set;}

		/// <summary> The third row and first column value. </summary>
		public float M31 {get; set;}

		/// <summary> The third row and second column value. </summary>
		public float M32 {get; set;}

		/// <summary> The third row and third column value. </summary>
...
#region  Constructors
		...
		/// <summary> Instantiate a new matrix from a 4x4 matrix. </summary>
		/// <remarks> The resulting matrix is the upper-left 3x3 slice. </remarks>
...
#region  Indexers
		/// <summary> Index the matrix row-major. </summary>
		...
		/// <summary> Index the matrix by row and column entry. </summary>
		public float this[int row, int column] {
			get => this[Width * row + column];
			set => this[Width * row + column] = value;
		}
#endregion  // Indexers
...
#region  IEquatable<T>
		...
		public bool Equals(Matrix3x3 other) {
			...
			for (var i = 0; i < Height * Width; ++i) {
				result &= Mathf.Abs(this[i] - other[i]) < Mathf.Epsilon;
				if (!result) {
					break;
				}
			}
