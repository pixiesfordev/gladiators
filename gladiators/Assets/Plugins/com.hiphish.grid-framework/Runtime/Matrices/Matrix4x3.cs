...
#region  Properties
		...
		/// <summary> The fourth row and first column value. </summary>
		public float M41 {get; set;}

		/// <summary> The fourth row and second column value. </summary>
		public float M42 {get; set;}

		/// <summary> The fifth row and third column value. </summary>
